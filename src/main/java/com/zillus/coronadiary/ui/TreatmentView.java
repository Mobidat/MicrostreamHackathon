...
public class TreatmentView extends VerticalLayout implements HasTitle
{
	...
	/**
	 * Event handler delegate method for the {@link Button} {@link #btnOut}.
	 *
	 * @see ComponentEventListener#onComponentEvent(ComponentEvent)
	 * @eventHandlerDelegate Do NOT delete, used by UI designer!
	 */
	private void btnOut_onClick(final ClickEvent<Button> event)
	{
		GridExportDialog.open(this.gridTreatment);
	}
	...
	private void initUI()
	{
		...
		this.btnOut.addThemeVariants(ButtonVariant.LUMO_ERROR);
		this.btnOut.setIcon(FileIcons.PDF.create());
		...
		this.gridTreatment.addColumn(RenderedComponent.Renderer(GenColTreatmentDetail::new)).setKey("renderer")
			.setHeader("...").setFrozen(true).setSortable(false).setAutoWidth(true).setFlexGrow(0)
			.setTextAlign(ColumnTextAlign.CENTER);
		this.gridTreatment
			.addColumn(new LocalDateRenderer<>(AbstractTreatmentEntity::getDate,
				DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM), "No date"))
		...
		this.gridTreatment.setSizeFull();
		...
		this.btnOut.addClickListener(this::btnOut_onClick);
	} // </generated-code>

	// <generated-code name="variables">
	private ComboBox<PatientEntity>       cmbPatient;
	private Button                        addSymptomBtn, addTestingBtn, addMedicationBtn, addVaccinationBtn, btnOut;
