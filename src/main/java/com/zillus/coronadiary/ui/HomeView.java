...
public class HomeView extends VerticalLayout implements HasTitle
{
	...
	{
		this.h2Patient.setText("Number of Patients: " + PersonDAO.countAllPatients());
		this.h2Medicals.setText("Number of Medicals: " + PersonDAO.countAllMedicals());
		this.h2Entries.setText("Number of Diary Entries: " + TreatmentDAO.countAllTreatments());
	}
	...
	private void initUI()
	{
		...
		this.btnMedicals.setText("200 Medical Data");
		this.btnMedicals.setIcon(VaadinIcon.PLUS.create());
		this.h2Entries.setText("none");
		this.btnEntries.setText("6000 Diary Data");
		this.btnEntries.setIcon(VaadinIcon.PLUS.create());
