...
public class TestingPopup extends Dialog
{
	...
	{
		this.cmbTest.setItemLabelGenerator(typ -> typ.toString());
		this.cmbTest.setItems(Testprocedure.values().toString());
	...
	private void initUI()
	{
		...
		this.binder.forField(this.cmbTest).withNullRepresentation("").bind(TestingEntity::getType,
			TestingEntity::setType);
