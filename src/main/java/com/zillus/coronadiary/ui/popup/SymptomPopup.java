...
public class SymptomPopup extends Dialog
{
	...
	{
		this.cmbSymptom.setItemLabelGenerator(typ -> typ.toString());
		this.cmbSymptom.setItems(Symptoms.values().toString());
	...
	private void initUI()
	{
		...
		this.binder.forField(this.cmbSymptom).withNullRepresentation("").bind(SymptomEntity::getType,
			SymptomEntity::setType);
